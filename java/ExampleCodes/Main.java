...
public class Main {
     ...
     * This is where you decide the following:
     * 1. What documents needs to be signed (suports PDF only).
     ...
     * The signing batch contains a group of signing processes with status of who have signed.
